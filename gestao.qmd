...
Entre 2023 e 2026, conseguimos quatro novos cargos PAEPE, com muito empenho por parte da direção. Hoje nosso quadro PAEPE conta com 44 servidores (Figura 3), divididos entre as seções administrativas, biblioteca e atendimento aos laboratórios. Nesse quadro, temos 1 servidor afastado e 1 aguardando transferência para a FT, e ainda, servidores que nos próximos anos entrarão com pedido de aposentadoria.


::: {.centerText}
![Quadro de servidores PAEPE da Faculdade de Tecnologia.](figs/servidores-paepe.png){width=80%}
:::
...
Atualmente, temos *78 docentes ativos*, e se considerarmos três contratações em andamento (1 para a área ambiental e 2 para o curso de inteligência artificial), teremos no início de 2026, 81 docentes. Temos ainda, três cargos que estão aguardando abertura de concurso, que não foram contabilizados. 

::: {.centerText}
![Quadro de docentes e sua distribuição por áreas.](figs/docentes-por-area.png){width=80%}
:::

Também tivemos, na atual gestão, um aumento expressivo no número de professores titulares. Foram realizados sete concursos, encerrando 2026 com uma distribuição mais equilibrada de professores titulares entre as diferentes áreas da FT (Figura 5).


::: {.centerText}
![Distribuição de professores titulares nas áreas da FT.](figs/titulares-por-area.png){width=80%}
:::
...
Por fim, entendemos ser necessária a *atenção às carreiras docentes* da FT. Atualmente, nossa Unidade conta com duas carreiras: o Magistério Superior (MS) e o Magistério Tecnológico Superior (MTS) (Figura 6). 

::: {.centerText}
![Número de docentes nas carreiras MTS e MS na FT, por nível[^3].](figs/mts-ms.png){width=80%}
:::
